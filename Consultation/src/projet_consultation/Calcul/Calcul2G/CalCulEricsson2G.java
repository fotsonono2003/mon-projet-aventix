...
public class CalCulEricsson2G
{
    ...
    public CalCulEricsson2G(Operateur operateur,String datedebut,String datefin) throws SQLException
    {
        dateDebut=datedebut;
        dateFin=datefin; 
    ...
    public void getBhParRegion(String region)
    {
        ...
        try
        {
            ...
            if(resultTotal.next())
            {
                ...
                {
                    Logger.getLogger(CalculHuawei2G.class.getName()).log(Level.SEVERE, null, ex);
                    nbreJrsHrs=0;
                }
            }
