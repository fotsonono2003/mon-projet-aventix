...
public class CalculAlcatel3G
{
    ...
    public CalculAlcatel3G(Operateur operateur, String datedebut, String datefin) throws SQLException
    {
        dateDebut = datedebut;
        dateFin = datefin;
    ...
    private void CalculRegion(String region)
    {
        try
        {
            ...
            try {
                ...
                Logger.getLogger(CalculAlcatel3G.class.getName()).log(Level.SEVERE, null, ex);
                NbreErgRecus = 0;
            }
