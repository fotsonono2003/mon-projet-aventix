...
public class CalculZTE3G
{
    ...
    public CalculZTE3G(Operateur operateur, String dateDebut, String dateFin) throws SQLException
    {
    ...
    private void CalculRegion(String region)
    {
        try
        {
            ...
            {
                Logger.getLogger(CalculZTE3G.class.getName()).log(Level.SEVERE, null, ex);
                NbreErgRecus = 0;
            }
