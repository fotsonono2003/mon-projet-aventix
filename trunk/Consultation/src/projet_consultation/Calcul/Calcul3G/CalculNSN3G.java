...
public class CalculNSN3G {
    ...
    public CalculNSN3G(Operateur operateur, String dateDebut, String dateFin) throws SQLException
    {
    ...
    private void CalculRegion(String region)
    {
        try
        {
            ...
            try {
                ...
                Logger.getLogger(CalculNSN3G.class.getName()).log(Level.SEVERE, null, ex);
                NbreErgRecus = 0;
            }
