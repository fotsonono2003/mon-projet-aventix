...
<div id="conteneur">
	<header >
    	...
    	<span>
  		<%
  			if(employeur!=null)
  			{
  				out.write("Connecté en tant que: <a href=\"employeur?action=deconnexion\">"+employeur.getLogin()+"</a>");
  			}
  			else
  			{
    ...
    <h2 style="color:blue;text-align: center;">Bonjour :<% if(employeur!=null){out.write(employeur.getRaisonsocial());} %></h2>
   	...
   	<section id="content">
		...
		<article>
            <form id="formulaire"  method="post" enctype="" name="formulaire">
                <fieldset><legend>Modifier mon compte</legend>
                ...
                <%
                	...
                	{
                		erreur=null;
                		System.out.println("l'erreur est nulle");
                	}
                %>
                </span>
                    <ol>
                        <li>
                        	<label for="name">Raison Sociale modifier : </label>
